#!/usr/bin/env python3
"""
Test script for OTHER rate regression models.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Test OTHER rate regression models.")
    parser.add_argument(
        "--model-dir",
        required=True,
...
def main() -> None:
    ...
    if target_mode != "rate":
        raise ValueError(f"metadata.target_mode={target_mode} is not 'rate'; use test_other_value.py instead.")
