#!/usr/bin/env python3
"""
Grid-search autotuning driver for the MLP-with-history regressor (value-domain).
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run MLP-with-history autotuning grid search.")
