#!/usr/bin/env python3
"""
Bayesian optimization autotuning driver for OTHER value regression targets.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Bayesian optimization for OTHER value targets.")
...
def main() -> None:
    ...
    run_bayesian_optimization(
        ...
        training_script="scripts/train_other_regression.py",
        model_name_prefix=f"{args.model_type.lower()}-other-value",
    )
