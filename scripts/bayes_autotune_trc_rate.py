#!/usr/bin/env python3
"""
Bayesian optimization autotuning driver for TRC rate regression targets.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Bayesian optimization for TRC rate targets.")
...
def main() -> None:
    ...
    run_bayesian_optimization(
        ...
        training_script="scripts/rate_train_trc_regression.py",
        model_name_prefix=f"{args.model_type.lower()}-trc-rate",
    )
