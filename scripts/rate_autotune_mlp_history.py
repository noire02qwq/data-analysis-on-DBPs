#!/usr/bin/env python3
"""
Grid-search autotuning driver for the rate-based MLP-with-history regressor.
"""
...
DEFAULT_BASE_CONFIG = Path("models/configs/mlp_with_history_config.yaml")
DEFAULT_GRID_CONFIG = Path("models/configs/mlp_with_history_grid.yaml")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run rate-based MLP-with-history autotuning grid search.")
